...
one, so sit back and grab a [chocolate gujia](https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_300,h_300,c_fit/uctifimyzfngegnzujrc) (and preferably view this on your laptop)
...
get the time to do this properly, and the second semester started <strike> a few days ago :/ </strike> tomorrow, so hard deadline :/ I'll try to get part 2 out
